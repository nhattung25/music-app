    ...
    <div>
      <Container className="playlist">
        <Row>
          ...
          <Col md={8} className="playing-info">
            <Row className="playing-title">
              <Col>
                <span>Đang phát</span>
              </Col>
              <Col>
            ...
            <Row>
              <Col className="playing-song">
                <div className="playing-song-info">
                  <img
                    className="playing-song-thumbnail"
                    src="https://firebasestorage.googleapis.com/v0/b/banx-mp3-player.appspot.com/o/images%2Fblackpink.jpeg?alt=media&token=88cc5c84-2b32-41b3-a313-f0849c260930"
                    alt=""
                  />
                  <div>
                    <div className="playing-song-name">Cô ấy của anh ấy</div>
                    <div className="playing-song-singer">Bảo Anh</div>
                  </div>
                </div>
                <div className="time-limit">05:00</div>
              </Col>
            </Row>
          </Col>
          <Row></Row>
